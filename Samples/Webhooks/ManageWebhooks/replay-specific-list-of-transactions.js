...
function replay_specific_list_of_transactions(callback, webhookId) {
	try {
		...
		var requestObj = new cybersourceRestApi.ReplayWebhooks();
		...
		instance.replayPreviousWebhook(webhookId, requestObj, opts, function (error, data, response) {
			if(error) {
