...
function create_webhook_using_oauth_with_jwt(callback) {
	// try {
	...
	// 	var securityPolicyConfig = new cybersourceRestApi.Notificationsubscriptionsv1webhooksSecurityPolicy1Config();
	...
	// 	var securityPolicyConfigAdditionalConfig = new cybersourceRestApi.Notificationsubscriptionsv1webhooksSecurityPolicy1ConfigAdditionalConfig();
...
if (require.main === module) {
	create_webhook_using_oauth_with_jwt(function () {
		console.log('\nCreateWebhookSubscription end.');
	});
}

module.exports.create_webhook_using_oauth_with_jwt = create_webhook_using_oauth_with_jwt;