...
function create_webhook_using_oauth_with_client_credentials(callback) {
	try {
...
if (require.main === module) {
	create_webhook_using_oauth_with_client_credentials(function () {
		console.log('\nCreateWebhookSubscription end.');
	});
}

module.exports.create_webhook_using_oauth_with_client_credentials = create_webhook_using_oauth_with_client_credentials;