...
if (require.main === module) {
	create_alternative_payments_notification_webhook(function () {
		console.log('\nCreateWebhook end.');
	});
}

module.exports.create_alternative_payments_notification_webhook = create_alternative_payments_notification_webhook;