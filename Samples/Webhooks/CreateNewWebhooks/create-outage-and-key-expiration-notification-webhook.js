...
function create_outage_and_key_expiration_notification_webhook(callback) {
	try {
		...
		eventTypes.push("cns.outage.notify.freeform");
		eventTypes.push("cns.report.keyExpiration.detail");
...
if (require.main === module) {
	create_outage_and_key_expiration_notification_webhook(function () {
		console.log('\nCreateWebhook end.');
	});
}

module.exports.create_outage_and_key_expiration_notification_webhook = create_outage_and_key_expiration_notification_webhook;