...
function create_invoicing_webhook(callback) {
	try {
		...
		eventTypes.push("invoicing.customer.invoice.cancel");
		eventTypes.push("invoicing.customer.invoice.overdue-reminder");
		eventTypes.push("invoicing.customer.invoice.paid");
		eventTypes.push("invoicing.customer.invoice.partial-payment");
		eventTypes.push("invoicing.customer.invoice.partial-resend");
		eventTypes.push("invoicing.customer.invoice.reminder");
		eventTypes.push("invoicing.customer.invoice.send");
...
if (require.main === module) {
	create_invoicing_webhook(function () {
		console.log('\nCreateWebhookSubscription end.');
	});
}

module.exports.create_invoicing_webhook = create_invoicing_webhook;