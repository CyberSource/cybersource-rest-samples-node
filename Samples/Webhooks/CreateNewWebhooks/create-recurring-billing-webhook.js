...
function create_recurring_billing_webhook(callback) {
	try {
		...
		eventTypes.push("rbs.subscriptions.charge.pre-notified");
		eventTypes.push("rbs.subscriptions.charge.created");
		eventTypes.push("rbs.subscriptions.charge.failed");
...
if (require.main === module) {
	create_recurring_billing_webhook(function () {
		console.log('\nCreateWebhook end.');
	});
}

module.exports.create_recurring_billing_webhook = create_recurring_billing_webhook;