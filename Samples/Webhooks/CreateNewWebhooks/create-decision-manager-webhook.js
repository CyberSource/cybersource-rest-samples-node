...
function create_decision_manager_webhook(callback) {
	// try {
...
if (require.main === module) {
	create_decision_manager_webhook(function () {
		console.log('\nCreateWebhookSubscription end.');
	});
}

module.exports.create_decision_manager_webhook = create_decision_manager_webhook;