...
function create_token_management_webhook(callback) {
	try {
		...
		eventTypes.push("tms.networktoken.provisioned");
		eventTypes.push("tms.networktoken.updated");
		eventTypes.push("tms.token.pan_updated");
		eventTypes.push("tms.token.created");
		eventTypes.push("tms.token.updated");
...
if (require.main === module) {
	create_token_management_webhook(function () {
		console.log('\nCreateWebhook end.');
	});
}

module.exports.create_token_management_webhook = create_token_management_webhook;