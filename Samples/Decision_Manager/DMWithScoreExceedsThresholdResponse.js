...
function dMWithScoreExceedsThresholdResponse(callback) {
	try {
...
if (require.main === module) {	
		dMWithScoreExceedsThresholdResponse(function () {
		console.log('\nCreateDecisionManagerCase end.');
	},);
}
module.exports.dMWithScoreExceedsThresholdResponse = dMWithScoreExceedsThresholdResponse;
