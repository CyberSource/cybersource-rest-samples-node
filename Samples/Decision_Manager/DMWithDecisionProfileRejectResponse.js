...
function dMWithDecisionProfileRejectResponse(callback) {
	try {
...
if (require.main === module) {	
		dMWithDecisionProfileRejectResponse(function () {
		console.log('\nCreateDecisionManagerCase end.');
	},);
}
module.exports.dMWithDecisionProfileRejectResponse = dMWithDecisionProfileRejectResponse;
