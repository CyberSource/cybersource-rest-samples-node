...
function dMWithMerchantDefinedInformation(callback) {
	try {
...
if (require.main === module) {	
		dMWithMerchantDefinedInformation(function () {
		console.log('\nCreateDecisionManagerCase end.');
	},);
}
module.exports.dMWithMerchantDefinedInformation = dMWithMerchantDefinedInformation;
