...
function bin_lookup_with_card(callback) {
	try {
		var configObject = new configuration();
		var apiClient = new cybersourceRestApi.ApiClient();
		var requestObj = new cybersourceRestApi.CreateBinLookupRequest();

		var clientReferenceInformation = new cybersourceRestApi.Binv1binlookupClientReferenceInformation();
...
if (require.main === module) {
	bin_lookup_with_card(function () {
		console.log('\nGetAccountInfo end.');
	});
}

module.exports.bin_lookup_with_card = bin_lookup_with_card;