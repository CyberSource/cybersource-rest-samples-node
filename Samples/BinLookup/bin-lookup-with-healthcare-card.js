...
function bin_lookup_with_healthcare_card(callback) {
	try {
...
if (require.main === module) {
	bin_lookup_with_healthcare_card(function () {
		console.log('\nGetAccountInfo end.');
	});
}

module.exports.bin_lookup_with_healthcare_card = bin_lookup_with_healthcare_card;