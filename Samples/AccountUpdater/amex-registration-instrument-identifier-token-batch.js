...
function amex_registration_instrument_identifier_token_batch(callback) {
	try {
...
if (require.main === module) {
	amex_registration_instrument_identifier_token_batch(function () {
		console.log('\nPostBatch end.');
	});
}

module.exports.amex_registration_instrument_identifier_token_batch = amex_registration_instrument_identifier_token_batch;
