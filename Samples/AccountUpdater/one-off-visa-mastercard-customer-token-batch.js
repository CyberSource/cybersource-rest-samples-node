...
function one_off_visa_mastercard_customer_token_batch(callback) {
	try {
...
if (require.main === module) {
	one_off_visa_mastercard_customer_token_batch(function () {
		console.log('\nPostBatch end.');
	});
}

module.exports.one_off_visa_mastercard_customer_token_batch = one_off_visa_mastercard_customer_token_batch;
