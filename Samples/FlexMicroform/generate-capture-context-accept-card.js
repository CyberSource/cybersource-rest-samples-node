...
function generate_capture_context_accept_card(callback) {
    try {
...
if (require.main === module) {
    generate_capture_context_accept_card(function () {
        console.log('\nGenerateCaptureContext end.');
    });
}

module.exports.generate_capture_context_accept_card = generate_capture_context_accept_card;