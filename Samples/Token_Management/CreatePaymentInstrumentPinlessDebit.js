...
function createPaymentInstrumentPinlessDebit(callback, profileid) {
	try {
...
if (require.main === module) {	
		...
		createPaymentInstrumentPinlessDebit(function () {
		console.log('\nCreatePaymentInstrument end.');
	},profileid);
}
module.exports.createPaymentInstrumentPinlessDebit = createPaymentInstrumentPinlessDebit;
