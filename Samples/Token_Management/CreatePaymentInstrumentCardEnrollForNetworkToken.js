...
function createPaymentInstrumentCardEnrollForNetworkToken(callback, profileid) {
	try {
...
if (require.main === module) {	
		...
		createPaymentInstrumentCardEnrollForNetworkToken(function () {
		console.log('\nCreatePaymentInstrument end.');
	},profileid);
}
module.exports.createPaymentInstrumentCardEnrollForNetworkToken = createPaymentInstrumentCardEnrollForNetworkToken;
