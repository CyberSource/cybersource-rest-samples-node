...
function createPaymentInstrumentCard(callback, profileid) {
	try {
...
if (require.main === module) {	
		...
		createPaymentInstrumentCard(function () {
		console.log('\nCreatePaymentInstrument end.');
	},profileid);
}
module.exports.createPaymentInstrumentCard = createPaymentInstrumentCard;
