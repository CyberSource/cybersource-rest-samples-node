...
function createPaymentInstrumentCardWithInstrumentIdentifierId(callback, profileid) {
	try {
...
if (require.main === module) {	
		...
		createPaymentInstrumentCardWithInstrumentIdentifierId(function () {
		console.log('\nCreatePaymentInstrument end.');
	},profileid);
}
module.exports.createPaymentInstrumentCardWithInstrumentIdentifierId = createPaymentInstrumentCardWithInstrumentIdentifierId;
