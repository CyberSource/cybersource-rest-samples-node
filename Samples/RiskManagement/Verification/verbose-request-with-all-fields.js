...
function verbose_request_with_all_fields(callback) {
	try {
...
if (require.main === module) {
	verbose_request_with_all_fields(function () {
		console.log('\nVerifyCustomerAddress end.');
	});
}
module.exports.verbose_request_with_all_fields = verbose_request_with_all_fields;
