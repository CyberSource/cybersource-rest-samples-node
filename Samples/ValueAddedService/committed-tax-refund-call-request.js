...
function committed_tax_refund_call_request(callback) {
	try {
...
if (require.main === module) {	
		committed_tax_refund_call_request(function () {
		console.log('\nCalculateTax end.');
	});
}
module.exports.committed_tax_refund_call_request = committed_tax_refund_call_request;
