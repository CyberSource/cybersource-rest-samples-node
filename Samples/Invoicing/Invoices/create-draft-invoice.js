...
function create_draft_invoice(callback) {
	try {
		...
		invoiceInformation.description = faker.lorem.sentence(5);
		var date = new Date();
		...
		orderInformationAmountDetails.subAmount = totalAmount - discountAmount;
...
if (require.main === module) {	
		create_draft_invoice(function () {
		console.log('\nCreateInvoice end.');
	});
}
module.exports.create_draft_invoice = create_draft_invoice;
