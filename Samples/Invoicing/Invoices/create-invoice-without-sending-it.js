...
function create_invoice_without_sending_it(callback) {
	try {
...
if (require.main === module) {	
		create_invoice_without_sending_it(function () {
		console.log('\nCreateInvoice end.');
	});
}
module.exports.create_invoice_without_sending_it = create_invoice_without_sending_it;
