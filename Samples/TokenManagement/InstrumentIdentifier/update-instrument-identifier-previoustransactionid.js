...
function update_instrument_identifier_previoustransactionid(callback) {
	...
	try {
		...
		var processingInformation = new cybersourceRestApi.TmsPaymentInstrumentProcessingInfoBankTransferOptions();
		var processingInformationAuthorizationOptions = new cybersourceRestApi.TmsAuthorizationOptions();
		var processingInformationAuthorizationOptionsInitiator = new cybersourceRestApi.TmsAuthorizationOptionsInitiator();
		var processingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction = new cybersourceRestApi.MerchantInitiatedTransactionObject();
