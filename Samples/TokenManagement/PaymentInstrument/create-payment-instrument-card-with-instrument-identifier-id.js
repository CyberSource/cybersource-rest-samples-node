...
function create_payment_instrument_card_with_instrument_identifier_id(callback) {
...
if (require.main === module) {
	create_payment_instrument_card_with_instrument_identifier_id(function () {
		console.log('\nCreatePaymentInstrument end.');
	});
}
module.exports.create_payment_instrument_card_with_instrument_identifier_id = create_payment_instrument_card_with_instrument_identifier_id;
