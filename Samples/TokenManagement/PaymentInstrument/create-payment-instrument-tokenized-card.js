...
function create_payment_instrument_tokenized_card(callback) {
...
if (require.main === module) {
	create_payment_instrument_tokenized_card(function () {
		console.log('\nCreatePaymentInstrument end.');
	});
}
module.exports.create_payment_instrument_tokenized_card = create_payment_instrument_tokenized_card;
