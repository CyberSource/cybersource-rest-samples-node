...
function create_payment_instrument_pinless_debit(callback) {
...
if (require.main === module) {
	create_payment_instrument_pinless_debit(function () {
		console.log('\nPostPaymentInstrument end.');
	});
}
module.exports.create_payment_instrument_pinless_debit = create_payment_instrument_pinless_debit;
