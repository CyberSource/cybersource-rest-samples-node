...
function create_payment_instrument_card_enroll_for_network_token(callback) {
...
if (require.main === module) {
	create_payment_instrument_card_enroll_for_network_token(function () {
		console.log('\nCreatePaymentInstrument end.');
	});
}
module.exports.create_payment_instrument_card_enroll_for_network_token = create_payment_instrument_card_enroll_for_network_token;
