...
function processPaymentServiceFeesWithCreditCardTransaction(callback) {
	try {
...
if (require.main === module) {	
		processPaymentServiceFeesWithCreditCardTransaction(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentServiceFeesWithCreditCardTransaction = processPaymentServiceFeesWithCreditCardTransaction;
