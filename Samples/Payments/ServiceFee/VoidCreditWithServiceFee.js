...
var processCredit = require('./ProcessCreditWithServiceFee');
/**
 * This is a sample code to call VoidApi,
 * Void a Credit
 * Include the credit ID in the POST request to cancel the credit.
 */
function voidCreditWithServiceFee(callback) {
	...
	try {
		...
		clientReferenceInformation.code = 'test_credit_void_service_fee';

		var request = new cybersourceRestApi.VoidCreditRequest();
		request.clientReferenceInformation = clientReferenceInformation;

		processCredit.processACreditWithServiceFee(function (error, data) {
			if (data) {
				var id = data['id'];
				console.log('\n*************** Void Credit ********************* ' );
...
if (require.main === module) {
	voidCreditWithServiceFee(function () {
		console.log('Void credit end.');
	});
}
module.exports.voidCreditWithServiceFee = voidCreditWithServiceFee;