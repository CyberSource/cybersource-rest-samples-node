...
function processPaymentWithPartialAuthorization(callback) {
	try {
...
if (require.main === module) {	
		processPaymentWithPartialAuthorization(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentWithPartialAuthorization = processPaymentWithPartialAuthorization;
