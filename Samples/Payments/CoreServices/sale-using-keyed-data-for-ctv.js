...
function sale_using_keyed_data_for_ctv(callback) {
	try {
...
if (require.main === module) {	
		sale_using_keyed_data_for_ctv(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.sale_using_keyed_data_for_ctv = sale_using_keyed_data_for_ctv;
