...
function processPaymentWithGooglePay(callback) {
	try {
...
if (require.main === module) {	
		processPaymentWithGooglePay(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentWithGooglePay = processPaymentWithGooglePay;
