...
function serviceFeesAuthorizationReversal(callback, id) {
	try {
...
if (require.main === module) {	
		...
		serviceFeesAuthorizationReversal(function () {
		console.log('\nAuthReversal end.');
	},id);
}
module.exports.serviceFeesAuthorizationReversal = serviceFeesAuthorizationReversal;
