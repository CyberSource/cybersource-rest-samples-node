...
function processPaymentWithLevelIIData(callback) {
	try {
...
if (require.main === module) {	
		processPaymentWithLevelIIData(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentWithLevelIIData = processPaymentWithLevelIIData;
