...
function processPaymentSimpleAuthorizationRetail(callback) {
	try {
...
if (require.main === module) {	
		processPaymentSimpleAuthorizationRetail(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentSimpleAuthorizationRetail = processPaymentSimpleAuthorizationRetail;
