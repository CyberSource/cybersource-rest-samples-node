...
function authorization_with_dmaccept_pa_enroll(callback) {
	try {
...
if (require.main === module) {	
		authorization_with_dmaccept_pa_enroll(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_with_dmaccept_pa_enroll = authorization_with_dmaccept_pa_enroll;
