...
function sale_using_emv_technology_with_contact_read(callback) {
	try {
...
if (require.main === module) {	
		sale_using_emv_technology_with_contact_read(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.sale_using_emv_technology_with_contact_read = sale_using_emv_technology_with_contact_read;
