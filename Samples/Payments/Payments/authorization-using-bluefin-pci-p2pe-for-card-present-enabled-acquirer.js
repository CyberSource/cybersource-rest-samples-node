...
function authorization_using_bluefin_pci_p2pe_for_card_present_enabled_acquirer(callback) {
	try {
...
if (require.main === module) {	
		authorization_using_bluefin_pci_p2pe_for_card_present_enabled_acquirer(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_using_bluefin_pci_p2pe_for_card_present_enabled_acquirer = authorization_using_bluefin_pci_p2pe_for_card_present_enabled_acquirer;
