...
function authorization_using_bluefin_pci_p2pe(callback) {
	try {
...
if (require.main === module) {	
		authorization_using_bluefin_pci_p2pe(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_using_bluefin_pci_p2pe = authorization_using_bluefin_pci_p2pe;
