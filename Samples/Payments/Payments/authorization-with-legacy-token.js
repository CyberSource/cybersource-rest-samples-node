...
function authorization_with_legacy_token(callback) {
	try {
...
if (require.main === module) {	
		authorization_with_legacy_token(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_with_legacy_token = authorization_with_legacy_token;
