...
function sale_using_emv_technology_with_contactless_read_for_card_present_enabled_acquirer(callback) {
	try {
...
if (require.main === module) {	
		sale_using_emv_technology_with_contactless_read_for_card_present_enabled_acquirer(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.sale_using_emv_technology_with_contactless_read_for_card_present_enabled_acquirer = sale_using_emv_technology_with_contactless_read_for_card_present_enabled_acquirer;
