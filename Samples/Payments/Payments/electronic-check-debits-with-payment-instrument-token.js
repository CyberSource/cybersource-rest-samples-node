...
function electronic_check_debits_with_payment_instrument_token(callback) {
	try {
...
if (require.main === module) {	
		electronic_check_debits_with_payment_instrument_token(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.electronic_check_debits_with_payment_instrument_token = electronic_check_debits_with_payment_instrument_token;
