...
if (require.main === module) {	
		authorization_capture_for_timeout_void_flow(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_capture_for_timeout_void_flow = authorization_capture_for_timeout_void_flow;
