...
function mit_industry_practice_resubmission(callback) {
	try {
...
if (require.main === module) {
	mit_industry_practice_resubmission(function () {
		console.log('\nCreatePayment end.');
	});
}

module.exports.mit_industry_practice_resubmission = mit_industry_practice_resubmission;