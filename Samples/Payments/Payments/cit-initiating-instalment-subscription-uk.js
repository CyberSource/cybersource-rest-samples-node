...
function cit_initiating_instalment_subscription_uk(callback) {
	try {
...
if (require.main === module) {
	cit_initiating_instalment_subscription_uk(function () {
		console.log('\nCreatePayment end.');
	});
}

module.exports.cit_initiating_instalment_subscription_uk = cit_initiating_instalment_subscription_uk;