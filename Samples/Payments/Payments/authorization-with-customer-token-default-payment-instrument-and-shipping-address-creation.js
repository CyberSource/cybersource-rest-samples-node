...
function authorization_with_customer_token_default_payment_instrument_and_shipping_address_creation(callback) {
	try {
...
if (require.main === module) {	
		authorization_with_customer_token_default_payment_instrument_and_shipping_address_creation(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_with_customer_token_default_payment_instrument_and_shipping_address_creation = authorization_with_customer_token_default_payment_instrument_and_shipping_address_creation;
