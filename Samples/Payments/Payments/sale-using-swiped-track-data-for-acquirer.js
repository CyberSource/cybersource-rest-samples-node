...
function sale_using_swiped_track_data_for_acquirer(callback) {
	try {
...
if (require.main === module) {	
		sale_using_swiped_track_data_for_acquirer(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.sale_using_swiped_track_data_for_acquirer = sale_using_swiped_track_data_for_acquirer;
