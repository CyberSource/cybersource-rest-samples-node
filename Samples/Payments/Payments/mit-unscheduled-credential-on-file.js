...
function mit_unscheduled_credential_on_file(callback) {
	try {
...
if (require.main === module) {
	mit_unscheduled_credential_on_file(function () {
		console.log('\nCreatePayment end.');
	});
}

module.exports.mit_unscheduled_credential_on_file = mit_unscheduled_credential_on_file;