...
function sale_using_emv_technology_with_contact_read_with_visa_platform_connect(callback) {
	try {
...
if (require.main === module) {	
		sale_using_emv_technology_with_contact_read_with_visa_platform_connect(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.sale_using_emv_technology_with_contact_read_with_visa_platform_connect = sale_using_emv_technology_with_contact_read_with_visa_platform_connect;
