...
function payment_with_flex_transient_token(callback) {
	try {
...
if (require.main === module) {	
		payment_with_flex_transient_token(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.payment_with_flex_transient_token = payment_with_flex_transient_token;
