...
function mit_industry_practice_delayed_charge_3ri_visa(callback) {
	try {
...
if (require.main === module) {
	mit_industry_practice_delayed_charge_3ri_visa(function () {
		console.log('\nCreatePayment end.');
	});
}

module.exports.mit_industry_practice_delayed_charge_3ri_visa = mit_industry_practice_delayed_charge_3ri_visa;