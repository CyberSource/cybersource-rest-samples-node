...
function authorization_with_decision_manager_buyer_information(callback) {
	try {
...
if (require.main === module) {	
		authorization_with_decision_manager_buyer_information(function () {
		console.log('\nCreatePayment end.');
	});
}
module.exports.authorization_with_decision_manager_buyer_information = authorization_with_decision_manager_buyer_information;
