...
function service_fees_with_credit_card_transaction(callback, enable_capture) {
	try {
...
module.exports.service_fees_with_credit_card_transaction = service_fees_with_credit_card_transaction;
