...
function processCreditWithServiceFees(callback) {
	try {
...
if (require.main === module) {	
		processCreditWithServiceFees(function () {
		console.log('\nCreateCredit end.');
	},);
}
module.exports.processCreditWithServiceFees = processCreditWithServiceFees;
