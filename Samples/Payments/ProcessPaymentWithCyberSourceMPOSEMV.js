...
function processPaymentWithCyberSourceMPOSEMV(callback) {
	try {
...
if (require.main === module) {	
		processPaymentWithCyberSourceMPOSEMV(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentWithCyberSourceMPOSEMV = processPaymentWithCyberSourceMPOSEMV;
