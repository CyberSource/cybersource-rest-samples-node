...
function pin_debit_credit_using_emv_technology_with_contactless_read_with_visa_platform_connect(callback) {
	try {
...
if (require.main === module) {	
		pin_debit_credit_using_emv_technology_with_contactless_read_with_visa_platform_connect(function () {
		console.log('\nCreateCredit end.');
	});
}
module.exports.pin_debit_credit_using_emv_technology_with_contactless_read_with_visa_platform_connect = pin_debit_credit_using_emv_technology_with_contactless_read_with_visa_platform_connect;
