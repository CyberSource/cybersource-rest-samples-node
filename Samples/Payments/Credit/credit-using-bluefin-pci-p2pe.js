...
function credit_using_bluefin_pci_p2pe(callback) {
	try {
...
if (require.main === module) {	
		credit_using_bluefin_pci_p2pe(function () {
		console.log('\nCreateCredit end.');
	});
}
module.exports.credit_using_bluefin_pci_p2pe = credit_using_bluefin_pci_p2pe;
