...
function pin_debit_credit_using_swiped_track_data_with_visa_platform_connect(callback) {
	try {
...
if (require.main === module) {	
		pin_debit_credit_using_swiped_track_data_with_visa_platform_connect(function () {
		console.log('\nCreateCredit end.');
	});
}
module.exports.pin_debit_credit_using_swiped_track_data_with_visa_platform_connect = pin_debit_credit_using_swiped_track_data_with_visa_platform_connect;
