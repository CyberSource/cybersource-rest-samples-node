...
function processPaymentWithLevelIIIData(callback) {
	try {
		...
		var  lineItems1 = new cybersourceRestApi.Ptsv2paymentsOrderInformationLineItems();
...
if (require.main === module) {	
		processPaymentWithLevelIIIData(function () {
		console.log('\nCreatePayment end.');
	},);
}
module.exports.processPaymentWithLevelIIIData = processPaymentWithLevelIIIData;
