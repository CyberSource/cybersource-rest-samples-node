...
function createClassicStandardReportSubscription(callback) {
	try {
...
if (require.main === module) {			
	createClassicStandardReportSubscription(function () {
		console.log('\nCreateStandardOrClassicSubscription end.');
	});
}
module.exports.createClassicStandardReportSubscription = createClassicStandardReportSubscription;
